...
//		}
		...
		*/
		...
		for(int i = 0;i<3;i++) {
			for(int j =0;j<5;j++) {
				System.out.print(i+"0"+j+"호 관리비를 입력하세요 : ");
		...
		System.out.println("전체 관리비 평균 ㅣ "+ tt);
		// 전체만 구하기
		//int tt=0;
//		for(int i = 0; i<arr4.length;i++) {
//			for(int j =0; j<arr4[i].length;j++) {
...
//		System.out.println("전체 관리비 평균 ㅣ "+ tt);
		...
		System.out.println("가장 많이 나온 호 : " + max);
		System.out.println("가장 적게 나온 호 : " + min);
